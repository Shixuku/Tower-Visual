...
public:
	...
	void CreatSpacer(vector<Element_Beam>& m_Elements_Truss, int SectionId,vector<int> ids);//几个点成环 生成间隔棒
	void CreateStrainLine(vector<Element_Truss>& Temp_Truss, double x,double y,double z,vector<int> ids,int ClassId);//将耐张串的环连在一个点上
