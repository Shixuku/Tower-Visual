...
public:
	...
	void CreatSpacer(vector<Element_Beam>& m_Elements_Beams, int SectionId,vector<int> ids);//几个点成环 生成间隔棒
	void CreatTestSpacer(vector<Element_Truss>& m_Elements_Beams, vector<int> ids);//几个点成环 生成间隔棒
