...
set_target_properties(VTK::GUISupportQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkGUISupportQt-9.0d.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::CommonDataModel;VTK::FiltersExtraction;VTK::InteractionStyle"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkGUISupportQt-9.0d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS VTK::GUISupportQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_VTK::GUISupportQt "${_IMPORT_PREFIX}/lib/vtkGUISupportQt-9.0d.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQt-9.0d.dll" )
...
set_target_properties(VTK::ViewsQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkViewsQt-9.0d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkViewsQt-9.0d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS VTK::ViewsQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_VTK::ViewsQt "${_IMPORT_PREFIX}/lib/vtkViewsQt-9.0d.lib" "${_IMPORT_PREFIX}/bin/vtkViewsQt-9.0d.dll" )
...
set_target_properties(VTK::RenderingQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkRenderingQt-9.0d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkRenderingQt-9.0d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS VTK::RenderingQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_VTK::RenderingQt "${_IMPORT_PREFIX}/lib/vtkRenderingQt-9.0d.lib" "${_IMPORT_PREFIX}/bin/vtkRenderingQt-9.0d.dll" )
...
set_target_properties(VTK::GUISupportQtSQL PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-9.0d.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::vtksys"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-9.0d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS VTK::GUISupportQtSQL )
list(APPEND _IMPORT_CHECK_FILES_FOR_VTK::GUISupportQtSQL "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-9.0d.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-9.0d.dll" )
